...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        navigationBarAppearance.titleTextAttributes = [ NSFontAttributeName: UIFont(name: "It Must Be Destroyed", size: 22)!,  NSForegroundColorAttributeName: UIColor.whiteColor()]
        ...
        Parse.setApplicationId("gdCuhbaw0Zho7GYGlhjU1UJcrEGHQ3ONxrldlOFa", clientKey: "1jHUWHm2ctVKgONGU1nxRDPpdPtWaf3zdhzaMCvK")
